...
RUN dnf -y update && \
    dnf -y install \
        ...
        nss atk at-spi2-core gtk3 pango \
        libXcomposite libXrandr libXcursor libXdamage libXfixes libXrender libXi libXScrnSaver \
        alsa-lib cups-libs libdrm mesa-libgbm \
        dejavu-fonts-all liberation-fonts fontconfig && \
